...
class ModelAccountMessageDetail extends Model {
	...
	public function addMessage($data) {
		...
		$c_subject    	=  !empty($module_laguage[$this->config->get('config_language_id')]['v_message'])?$module_laguage[$this->config->get('config_language_id')]['v_subject']:'';
		$c_message    	=  !empty($module_laguage[$this->config->get('config_language_id')]['v_message'])?$module_laguage[$this->config->get('config_language_id')]['v_message']:'';
