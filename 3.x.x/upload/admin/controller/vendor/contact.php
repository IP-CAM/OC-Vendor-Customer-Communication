...
class ControllerVendorContact extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);

		$data['reset'] = $this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'], '', true);
		$data['delete'] = $this->url->link('vendor/contact/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['inquires'][] = array(
				...
				'edit'        => $this->url->link('vendor/contact/edit', 'user_token=' . $this->session->data['user_token'] . '&inquiry_id=' . $result['inquiry_id'] . $url, true),
				'view'        => $this->url->link('vendor/contact/view', 'user_token=' . $this->session->data['user_token'] . '&inquiry_id=' . $result['inquiry_id'] . $url, true),
		...
		$data['sort_name']     = $this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
		$data['sort_email']    = $this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'] . '&sort=email' . $url, true);
		$data['sort_product']  = $this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'] . '&sort=product' . $url, true);
		$data['sort_seller']   = $this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'] . '&sort=seller' . $url, true);
		$data['sort_customer'] = $this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'] . '&sort=customer' . $url, true);
		$data['sort_status']   = $this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, true);
		$data['sort_date']     = $this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'] . '&sort=date' . $url, true);
		...
		$pagination->url = $this->url->link('vendor/contact', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
	...
	public function view() {
		...
		foreach($message_show as $messagesinfo){
			$data['tmdmessages'][]=array(
				...
				'hreflink'     => $this->url->link('vendor/contact/download','user_token=' . $this->session->data['user_token'].'&message_id=' . $messagesinfo['message_id'].$url, true),
