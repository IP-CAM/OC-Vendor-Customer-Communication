<?php
namespace Opencart\Admin\Model\Extension\Tmdvendorcustomercommunication\Vendor;
class Contact extends \Opencart\System\Engine\Model {
	...
	public function getCustomers($data) {
		$sql = "SELECT c.customer_id, CONCAT(c.firstname, ' ', c.lastname) AS name FROM " . DB_PREFIX . "customer c LEFT JOIN " . DB_PREFIX . "customer_group_description cgd ON (c.customer_group_id = cgd.customer_group_id)";
