...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1><?php echo $heading_titleview; ?></h1>
      <ul class="breadcrumb">
            ...
            <div class="content msgsendform">
              <div class="table-responsive">
                <table class="table table-hover">
                  <thead>
                    <tr>
                      <td class="box1"><?php echo $description; ?></td>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                                ...
                                <?php foreach ($tmdmessages as $result) { ?>
                                  <?php if ($result['customer_id']) { ?>
                                    <li class="comment user-comment">
                                      ...
                                      <p class="message" style="margin-bottom: -17px;border-radius: 30px;margin-left: -100px;">
                                  ...
                                  <?php } else { ?> 
                                    <li class="comment author-comment">
                                      ...
                                      <p class="message pull-right" style="margin-bottom: -17px;border-radius: 30px;margin-left: -100px;">
                ...
                <div class="well">
                  <div class="row">
                    ...
                    <div class="button-group">
                      <input type="button" id="msgsend" style="margin-top:32px;margin-left:-40px;" value="<?php echo $button_submit; ?>" class="button message col-sm-6" />
                    </div>    
                  </div>
                </div>
              </div>
...
function messagedetail(json){
  ...
  html+='<div class="info">'; 
  html+='</div>';
  html+='<p class="message pull-right" style="margin-bottom: -17px;border-radius: 30px;margin-left: -100px;"><b>'+json['date_added']+'</b><b><span class="pull-right">'+json['message']+'</b>';
  if(json['filename']) {
  html+='<br/>';
